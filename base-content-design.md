...
* **[TONE‑01] Direct & Clear**
  DO NOT write vague or ambiguous text.
  Example: "Klik tombol "Mulai" untuk lanjut."

* **[TONE‑02] Supportive**
  DO NOT use blaming, judgmental, or condescending language.
  Example: "Anda dapat coba mulai dari sini."

* **[TONE‑03] Encouraging**
  Always promote progress, NOT perfection.
  Example: "Kerja bagus. Satu tahap lagi."
...
* Refer to users as **"Anda"**
* Refer to the system/platform as **"kami"**
...
* **[INC‑01]** Use descriptive, explicit verbs. DO NOT use vague actions such as "lihat".
* **[INC‑02]** NEVER use slang or unexplained jargon.
* **[INC‑03]** DO NOT rely on color or visual cues alone. Always describe meaning in text.
* **[INC‑04]** DO NOT assume gender, age, or region. Always remain neutral.
* **[INC‑05]** Alt text MUST be provided **only** when images add meaningful context.
...
* All future prompts MUST fully comply with this Base Prompt.
